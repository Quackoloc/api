...
export class Migration1753031064892 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "invitation_code" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "colocationId" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_fa9e818ade61aeee63f5d89baea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "colocation_task" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "dueDate" TIMESTAMP WITH TIME ZONE, "isRecurrent" boolean NOT NULL DEFAULT false, "status" "public"."colocation_task_status_enum" NOT NULL DEFAULT 'todo', "priority" "public"."colocation_task_priority_enum" NOT NULL DEFAULT 'medium', "colocationId" integer NOT NULL, "assignedToId" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_a0056fb4bfd782b0600bc1011a3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a0056fb4bfd782b0600bc1011a" ON "colocation_task" ("id") `);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "tasksRotationFrequency" integer NOT NULL DEFAULT '7'`);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "nextRotationDate" TIMESTAMP WITH TIME ZONE NOT NULL`);
        await queryRunner.query(`ALTER TABLE "colocation" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "colocation" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "colocation" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "colocation" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "colocation" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
